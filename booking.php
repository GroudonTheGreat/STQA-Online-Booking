							...
							<div class="col-md-12 text-center" style="padding-bottom:20px">
								...
								?>
									...
									<tr>
										...
										<?php mysqli_query($con,"insert into tbl_bookings values(NULL, 123,'".$_SESSION['theatre']."','".$_SESSION['user']."','".$_SESSION['show']."','".$screen['screen_id']."','".$screen['seats']."','".$screen['charge']."','".$date."',CURDATE(),'1')");
    									} ?>
										</form></td>
									</tr>
						<table>
